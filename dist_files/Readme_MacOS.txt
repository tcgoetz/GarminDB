...
3. Copy GarminConnectConfig.json.example to GarminConnectConfig.json, edit it, and add your Garmin Connect username and password and adjust the start dates to when your data starts from.
4. Create your databases if you have not used the program previously by doing one of:
...
5.  Update you databases regularly by doing one of:
...
Notes:
* If you are running MacOS 10.15 Catalina, then the GarminDb scripts will be blocked from running and you will have to give permission for them
