    ...
    def process(self, db_params_dict):
        ...
        with garmin_act_db.managed_session() as garmin_act_db_session:
            ...
            for lap in laps:
                ...
                track = self.tcx.lap(lap.start_time, lap.stop_time, distance.to_meters(), lap.calories)
                ...
                for record in records:
                    ...
                    self.tcx.point(track, record.timestamp, record.position, alititude.to_meters(), record.hr, speed.to_mps())
